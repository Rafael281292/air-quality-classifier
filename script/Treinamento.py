...
if __name__ == "__main__":
    ...
    modelo_dir = os.path.join(base_dir, "Modelo", modelo_name)
    ...
    label_encoder_path = os.path.join(modelo_dir, f"{modelo_name}_label_encoder.pkl")
    ...
    classes = le.classes_  # nomes originais das classes
    ...
    plt.tight_layout()
    plt.savefig(f"{pasta}/Confusion_Matrix_{modelo_name}.png", dpi=300, bbox_inches='tight')
    plt.close()
